import svgPaths from "./svg-fnd1etjjyu";
...
function Frame1() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-5 py-2 relative rounded-[100px] shrink-0">
...
function Frame7() {
  return (
    <div className="bg-[#ffaf40] box-border content-stretch flex flex-row gap-1 items-center justify-center px-3 py-2 relative rounded-[100px] shrink-0">
      <Robot2 />
...
function Frame6() {
  return (
    <div className="bg-gradient-to-b box-border content-stretch flex flex-col from-[#151515] h-[242px] items-end justify-between p-[32px] relative rounded-3xl shrink-0 to-[#151515e6] w-[776px]">
      ...
      <div
        className="font-['Poppins:Regular',_sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#b0b0b0] text-[14px] text-left"
        style={{ width: "min-content" }}
      >
        <p className="block leading-[normal]">Describe your agent AI</p>
      </div>
      <Frame7 />
    </div>
  );
...
export default function Component6() {
  return (
    <div className="bg-[#fff1e5] relative size-full" data-name="6">
      <div className="absolute bottom-[-1063px] left-[-73px] size-[1586px]">
        <img
          alt
          className="block max-w-none size-full"
          height="1586"
